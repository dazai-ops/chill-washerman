...
import { addWasher } from '@/lib/thunk/washer/washerThunk'
import { resetWasherForm, setWasherForm } from '@/redux/slices/washerSlice'
...
function WasherCreateModal() {
  const [open, setOpen] = useState(false)
  const [disabled, setDisabled] = useState(false)

  const dispatch = useDispatch<AppDispatch>()
  const {washerForm} = useSelector((state:RootState) => state.washer)
...
export default WasherCreateModal