...
import { getWasher } from '@/lib/thunk/mesincuci/mesincuciThunk'
...
import { updateDetailTransactionStatus } from '@/lib/thunk/transaksi/transaksiThunk'
...
function LayananEditProses({data}: {data: TransactionDetail}) {
  const dispatch = useDispatch<AppDispatch>()
  const [open, setOpen] = useState(false)
  const admin = useSelector((state: RootState) => state.auth.user)
  const {washerList} = useSelector((state: RootState) => state.mesinCuci)
...
export default LayananEditProses