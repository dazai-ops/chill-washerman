...
import { getApparel, updateApparel, addApparel, deleteApparel } from '@/lib/thunk/apparel/apparelThunk';
...
export const { setApparelForm, clearApparelForm } = apparelSlice.actions
